...
const Home = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>MR Food Machinery | Industrial Food Processing Machines & Turnkey Plants</title>
        <meta 
          name="description" 
          content="Leading manufacturer of commercial food processing machinery, extruders, high-capacity food processing plants, and SS 304 food grade equipment." 
        />
        <meta 
          name="keywords" 
          content="food processing machinery, industrial food equipment, food plant manufacturer, food processing line, SS 304 food machinery, turnkey food processing plant" 
        />
